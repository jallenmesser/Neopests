...
pest1 = Pest.find_or_create_by(id: 1, name: "Pongo", species: "squirrel", color: "normal", home: "Central Park", user_id: user1.id)
pest2 = Pest.find_or_create_by(id: 2, name: "Jeremy", species: "rat", color: "orange", home: "Subway", user_id: user1.id)
pest3 = Pest.find_or_create_by(id: 3, name: "Mortricia", species: "rat", color: "red", home: "Pizza shop", user_id: user1.id)
pest4 = Pest.find_or_create_by(id: 4, name: "Zingo", species: "pigeon", color: "splats", home: "central", user_id: user2.id)
